									...
									<div className="row g-4">
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<h6 className="my-3 fw-medium">Desenvolvimento Web</h6>
												<p className="fs-7 text-300 fw-regular">Criar interfaces visualmente atraentes e fáceis de usar utilizando <span className="text-secondary-2">HTML</span>, <span className="text-secondary-2">CSS</span>, <span className="text-secondary-2">JavaScript</span>, e frameworks modernos como React e Angular.</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<h6 className="my-3 fw-medium">Gerenciamento de banco de dados</h6>
												<p className="fs-7 text-300 fw-regular">Projetar e gerenciar bancos de dados com tecnologias SQL e NoSQL, como <span className="text-secondary-2">MySQL</span>, <span className="text-secondary-2">PostgreSQL</span>, e <span className="text-secondary-2">MongoDB</span>.</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<h6 className="my-3 fw-medium">Desenvolvimento de API's</h6>
												<p className="fs-7 text-300 fw-regular">Criando e integrando <span className="text-secondary-2">APIs RESTful</span> para permitir uma comunicação fluida entre os sistemas de front-end e back-end..</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<h6 className="my-3 fw-medium">Otimização de Aplicações</h6>
												<p className="fs-7 text-300 fw-regular">Aprimorar a velocidade e o desempenho de aplicativos web para proporcionar uma melhor experiência ao usuário. Trabalhar com <span className="text-secondary-2">Nodejs</span> e <span className="text-secondary-2">Express</span></p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<p className="fs-7 text-300 fw-regular">Desenvolver soluções de pagamento escaláveis ​​e seguras para <span className="text-secondary-2">plataformas de e-commerce</span> Adaptado às necessidades do seu negócio.</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<h6 className="my-3 fw-medium">Integrando IA</h6>
												<p className="fs-7 text-300 fw-regular">Potencialize seus aplicativos com IA para obter maior eficiência, automação e uma experiência de usuário aprimorada.</p>
											</div>
										</div>
									</div>
									<div className="text-center pt-60">
										<p className="text-300">
											Animado para começar <span className="text-dark">novos projetos</span> e ajudar. <br />
											Vamos conversar sobre suas ideias. <Link href="#" className="text-primary-2">Entre em contato!</Link>
										</p>
									</div>
								</div>
							</div>
