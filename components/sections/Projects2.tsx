						...
						<div className="box-linear-animation position-relative z-1">
							<div className="p-lg-8 p-md-6 p-3 position-relative z-1">
								<div className="d-flex align-items-center">
									...
									<span className="text-linear-4 d-flex align-items-center"> Portifólio </span>
								</div>
								<h3>Coheça Outros Projetos</h3>
													...
													<div className="row">
														...
														<div className="col-lg-7 ps-lg-5 mt-5 mt-lg-0">
															<h4 className="text-linear-4">
																Integração de IA no <br />
																sistema de e-commerce
															</h4>
															<p>Desenvolvi uma plataforma de aprendizado online com gerenciamento de cursos, questionários e acompanhamento de progresso.</p>
															<ul className="mt-4 list-unstyled">
																<li className="text-secondary-2 mb-3 border-bottom pb-3">Informações do Projeto</li>
																...
																<li className="text-dark mb-3 border-bottom pb-3">
																	<div className="d-flex justify-content-between">
																		<p className="text-dark mb-0 text-end">Tempo de Conclusão</p>
																		<p className="text-300 mb-0 text-end">6 meses</p>
																	</div>
																</li>
																<li className="text-dark mb-3 border-bottom pb-3">
																	<div className="d-flex justify-content-between">
																		<p className="text-dark mb-0 text-end">Tecnologias</p>
